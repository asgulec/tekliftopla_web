...
<table width="360px" border="0" align="center" cellpadding="0" cellspacing="0">
  <FORM action="bilgiguncelle.php" method=post name="frmBilgi" onsubmit="return Validate(this)">
    ...
    <tr>
      <td><TABLE align=center   cellPadding=4 cellSpacing=4 width=340 border="0">
          <TR>
    ...
    <tr>
      <td><table align=center bgcolor="#F6F6F6" cellPadding=4 cellSpacing=4 width="360px" border="0">
          <TR>
            <td colspan="2" class="not"bgcolor="#F6F6F6" >Lütfen  bilgilerinizde bulunmayan telefon numaranızı giriniz.</td>
          </TR>
...
function Kontrol() {
	if (document.forms.frmBilgi.Telefon.value=="" ) 
{ 
 	document.getElementById("yazi").value = " Telefon numaranızı giriniz. ";
