...
$query = "SELECT a.Firma_Adi, b.sehir, c.text, d.ulke from bilgi as a, sehir as b, kullanim as c, country as d where c.Kullanimid='$verified_kulid' and c.firmaid=a.firmaid and c.sehirid=b.sehirid and c.ulke=d.iso3";
...
$sehirx = $queryr['sehir']. " - ".$queryr['ulke'];
