  ...
  <div id="analong">
    <table width="97%" align="center" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr bgcolor="white"  >
        ...
        <td width="25%"></td>
        <td width="43%" align="right" class="title">Update Menu</td>
    ...
    <table align="center" width="95%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td bgcolor="#F6F6F6" colspan="4" align="left" class="Baslik" valign="middle">Update menu for <? echo $verified_firma;?></td>
      </tr>
      <tr>
        <td colspan="4"><table width="90%" border="0" align="center" cellpadding="2" cellspacing="5" >
            ...
            <TR>
              <td align="left" class="govde"><span style="font-weight: bold"><i class="icon-stop-b"></i></span><a href="guncel-e.php" class="link"> Update user info</a></td>
            </TR>
            <TR>
            ...
            <TR>
              <td align="left" class="govde"><span style="font-weight: bold"><i class="icon-stop-b"></i></span><a href="sil-e.php" class="link"> Disable user </a></td>
            </TR>
            <TR>
              <td align="left" class="govde"><span style="font-weight: bold"><i class="icon-stop-b"></i></span><a href="giris-e.php" class="link"> Return to user menu</a></td>
            </TR>
            <tr>
