...
if ($semail === '') {
    header("Location:forgetpass-e.php?sonuc=epostayok");
    exit;
}
...
if($no>0){
error_reporting(63);
$konu="tekliftopla.com user information";
...
<table width="600" border="0" align="center" cellpadding="2" cellspacing="0" bgcolor="#F9F9F9">
  ...
  <tr> 
    <td colspan="2"><div align="center"> 
        <p> <font size="2" face="Verdana, Arial, Helvetica, sans-serif">tekliftopla.com user information: </font></p>
        <table border="0" cellpadding="0" cellspacing="2" bgcolor="#EFEFEF">
          <tr>
            <td colspan="2"><table border="0" cellpadding="0" cellspacing="2" bgcolor="#FFFFFF">
                <tr> 
                  <td width="113" align="right"><font color="#6E9807" size="2" face="Verdana, Arial, Helvetica, sans-serif">E-mail :</font></td>
                  <td align="left"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">'. $kime. ' </font></td>
                </tr>
                <tr> 
                  <td colspan="2"><font color="#6E9807"><img src="../image/trans.gif" style="display: block;" width="1" height="2"></font></td>
                </tr>
                <tr> 
                  <td align="right"><font color="#6E9807" size="2" face="Verdana, Arial, Helvetica, sans-serif">Password :</font></td>
...
require_once("../class.phpmailer.php"); //Require file
  ...
  $mail->Encoding = "base64";
	...
	$mail->Send();     
header("Location:forgetpass-e.php?sonuc=tamam");
}
else{ 
header("Location:forgetpass-e.php?sonuc=epostayok");
}
