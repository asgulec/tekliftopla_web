  ...
  <div id="analong">
    <table width="97%" align="center" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr bgcolor="white"  >
        ...
        <td width="25%"></td>
        <td width="43%" align="right" class="title">Contact</td>
        <td width="7%" valign="bottom" align="right" ><img src="../image/sag_ok.gif"></td>
      </tr>
    </table>
    <table width="95%" cellspacing="1" cellpadding="5" align="center" border="0">
      <tbody>
        <tr>
          <td bgcolor="#F6F6F6" colspan="2" height="10"></td>
        </tr>
        <tr>
