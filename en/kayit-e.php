...
<div id="sayfa">
  ...
  <div id="analong">
    <table align="center" width="97%" border="0" cellspacing="0" cellpadding="0" bgcolor=white>
      <tr>
        ...
        <td><FORM id="frm" name="frm" method="post" action="ekle-e.php" >
            ...
            <TABLE width="95%"  border="0" align="center" cellpadding="2" cellspacing="0">
              ...
              <TR>
                ...
                <td width="50%" class="aciklama"><INPUT  maxLength=80 id="Firma_Adi" name="Firma_Adi" size="25" style="border: 1 solid #666666" value="<?php echo isset($_GET['Firma_Adi']) ? $_GET['Firma_Adi'] : '';?>" >
...
?>
              ...
              <TR>
                ...
                <td><font color=#004040 FONT-SIZE: "10px"><span style="font-weight: bold">
              ...
              <TR>
                ...
                <td><INPUT name="imgverrand" style="border: 1 solid #666666" size=25  maxLength=4>
...
?>
              ...
              <tr>
                <td colspan="2" align="left"height="30" valign="middle"><?php 
