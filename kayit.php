        ...
        <TABLE width="95%"  border="0" align="center" cellpadding="2" cellspacing="0">
            <TR>
			  ...
			  ?>
                  ...
                  <strong><span class="title_kucuk">Teklif toplamak ve seçeceğim iş kollarında teklif isteyenlerden haberdar olmak istiyorum </span></strong>
			  </div>
			  </td>
            </TR>
            <TR>
              <td colspan=2 align="left" valign="top" height="30" bgcolor="#F6F6F6">
                  ...
                  <strong><span class="title_kucuk">Sadece ihtiyaçlarım için teklif toplamak istiyorum </span></strong></td>
            </TR>
                          <?php
			  if(isset($_GET['c21'])) {
			  if($_GET['c21']=="Firma") {
            ...
            <TR >
                <td colspan=2 align="right" class="govde">
...
?>
            ...
            <TR>
              ...
              <td><font color=#004040 style="FONT-SIZE: 10px"><span style="font-weight: bold">
